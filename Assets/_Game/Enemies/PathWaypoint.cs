...
//
// Inspector'dan:
//   - next: BİR SONRAKİ PathWaypoint (yolun içindeki sıradaki nokta)
//   - waitTime: bu noktada yaratık kaç saniye beklesin
//   - speedMultiplier: bu noktada yaratık hızı çarpanı (0-1)
//   - gizmo rengi ve boyutu (sahne görünümü)
//
// Eski kullanım (next field): Yine de destekleniyor, sahne üzerinde interaktif
// şekilde yapılabilir. Yeni kullanım (child Points): parent'tan başlayarak
// child'lar sırayla takip edilir.
//
// BİR waypoint grubu oluşturmak için:
//   1) Boş bir GameObject oluştur, adı "Waypoint_1"
//   2) İçine boş GameObject'ler ekle (child), adları "Point_0", "Point_1"...
//   3) Bu child'ları sahnede güzergah boyunca yerleştir
//   4) Hiyerarşi: Waypoint_1 > Point_0 > Point_1 > Point_2 ...
//   5) Waypoint_1'i PathManager.startPoints'e ekle (sürükle-bırak)
//   6) Yaratıklar bu sırayla: spawn -> Point_0 -> Point_1 -> Point_2 -> bed
// =============================================================================
